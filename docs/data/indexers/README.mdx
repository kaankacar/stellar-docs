...
Still deciding which option fits? Start with an off-the-shelf API and move to a self-hosted indexer as your needs grow — you can allways change your approach later.
